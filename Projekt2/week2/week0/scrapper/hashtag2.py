...
for i, tweet in enumerate(sntwitter.TwitterHashtagScraper("amberheard since:2022-04-18 until:2022-04-24 lang:en")
                                  .get_items()):
...
with open('hashtags_amberheard.txt', 'w') as the_file:
...
pos_number = 0
neg_number = 0
with open('hashtags_amberheard_pos.txt', 'w') as the_file_pos:
    with open('hashtags_amberheard_neg.txt', 'w') as the_file_neg:
        for tweet in tweets_df1["Text"].tolist():
            ss = sid.polarity_scores(tweet)
