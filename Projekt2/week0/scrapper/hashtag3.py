...
for i, tweet in enumerate(sntwitter.TwitterHashtagScraper("JusticeForJohnnyDepp since:2021-04-10 until:2022-04-11 lang:en")
                                  .get_items()):
...
pos_number = 0
neg_number = 0
with open('hashtags_JusticeForJohnnyDepp_pos.txt', 'w') as the_file_pos:
    with open('hashtags_JusticeForJohnnyDepp_neg.txt', 'w') as the_file_neg:
        for tweet in tweets_df1["Text"].tolist():
            ss = sid.polarity_scores(tweet)
