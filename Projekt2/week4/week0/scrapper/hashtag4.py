...
for i, tweet in enumerate(sntwitter.TwitterHashtagScraper("AmberHeardIsAnAbuser since:2021-05-02 until:2022-05-08 lang:en")
                                  .get_items()):
...
with open('hashtags_amberabuser.txt', 'w') as the_file:
...
pos_number = 0
neg_number = 0
with open('hashtags_amberabuser_pos.txt', 'w') as the_file_pos:
    with open('hashtags_amberabuser_neg.txt', 'w') as the_file_neg:
        for tweet in tweets_df1["Text"].tolist():
            ss = sid.polarity_scores(tweet)
